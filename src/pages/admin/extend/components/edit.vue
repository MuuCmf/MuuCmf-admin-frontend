<template>
  <div class="extend-edit-wrapper">
    <div class="edit-header">
      <h3>{{ extend.id ? '编辑扩展' : '添加扩展' }}</h3>
    ...
    <div class="edit-content">
      <el-form ref="formRef" :model="formData" label-width="100px">
        ...
        <el-form-item label="配置标识" prop="name">
          <el-input v-model="formData.name" placeholder="请输入配置唯一标识（英文）" maxlength="50" show-word-limit />
...
watch(
  ...
  val => {
    if (val && val.id) {
      ...
      formData.group = String(val.group ?? 1);
